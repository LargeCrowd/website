...
class Site {
    ...
    changeCurrentOpenedPages(normalizedUrls) {
        ...
        this.currentOpenedPages = constants_1._.uniq(openedPages);
    ...
    readSiteConfig(baseUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            this.siteConfig = yield SiteConfig_1.SiteConfig.readSiteConfig(this.rootPath, this.siteConfigPath, baseUrl);
    ...
    createPage(config) {
        ...
        const pageConfig = new PageConfig_1.PageConfig({
            asset: {
                ...
                externalScripts: constants_1._.union(this.siteConfig.externalScripts, config.externalScripts),
    ...
    updateAddressablePages() {
        ...
        return constants_1._.difference(oldAddressablePagesSources, newAddressablePagesSources)
    ...
    collectAddressablePages() {
        ...
        const pagesFromSrc = constants_1._.flatMap(pages.filter(page => page.src), page => (Array.isArray(page.src)
        ...
        if (duplicatePages.length > 0) {
            throw new Error(`Duplicate page entries found in site config: ${constants_1._.uniq(duplicatePages).join(', ')}`);
        }
        ...
        pagesFromGlobs.concat(pagesFromSrc).forEach((page) => {
            const filteredPage = constants_1._.omitBy(page, constants_1._.isUndefined);
    ...
    buildManagers() {
        ...
        this.layoutManager = new Layout_1.LayoutManager(config);
    }
    /**
    ...
    _rebuildAffectedSourceFiles(filePaths) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const uniquePaths = constants_1._.uniq(filePathArray);
            this.beforeSiteGenerate();
            try {
                yield this.layoutManager.updateLayouts(filePathArray);
    ...
    _rebuildPagesBeingViewed(normalizedUrls) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const uniqueUrls = constants_1._.uniq(normalizedUrlArray);
    ...
    handlePageReload(oldAddressablePages, oldPagesSrc, oldSiteConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isNewPage = (newPage, oldPage) => constants_1._.isEqual(newPage, oldPage) || newPage.src === oldPage.src;
            const addedPages = constants_1._.differenceWith(this.addressablePages, oldAddressablePages, isNewPage);
            const removedPages = constants_1._.differenceWith(oldAddressablePages, this.addressablePages, isNewPage)
            ...
            const isGlobalConfigModified = () => !constants_1._.isEqual(oldSiteConfig.faviconPath, this.siteConfig.faviconPath)
                || !constants_1._.isEqual(oldSiteConfig.titlePrefix, this.siteConfig.titlePrefix)
                || !constants_1._.isEqual(oldSiteConfig.titleSuffix, this.siteConfig.titleSuffix)
                || !constants_1._.isEqual(oldSiteConfig.style, this.siteConfig.style)
                || !constants_1._.isEqual(oldSiteConfig.externalScripts, this.siteConfig.externalScripts)
                || !constants_1._.isEqual(oldSiteConfig.globalOverride, this.siteConfig.globalOverride)
                || !constants_1._.isEqual(oldSiteConfig.plugins, this.siteConfig.plugins)
                || !constants_1._.isEqual(oldSiteConfig.pluginsContext, this.siteConfig.pluginsContext)
                || !constants_1._.isEqual(oldSiteConfig.headingIndexingLevel, this.siteConfig.headingIndexingLevel)
                || !constants_1._.isEqual(oldSiteConfig.enableSearch, this.siteConfig.enableSearch)
                || !constants_1._.isEqual(oldSiteConfig.timeZone, this.siteConfig.timeZone)
                || !constants_1._.isEqual(oldSiteConfig.locale, this.siteConfig.locale)
                || !constants_1._.isEqual(oldSiteConfig.intrasiteLinkValidation, this.siteConfig.intrasiteLinkValidation)
                || !constants_1._.isEqual(oldSiteConfig.plantumlCheck, this.siteConfig.plantumlCheck);
            if (isGlobalConfigModified() || !constants_1._.isEmpty(addedPages) || !constants_1._.isEmpty(removedPages)) {
                ...
                const editedPages = constants_1._.differenceWith(this.addressablePages, oldAddressablePages, (newPage, oldPage) => constants_1._.isEqual(newPage, oldPage) || !oldPagesSrc.includes(newPage.src));
    ...
    handleIgnoreReload(oldIgnore) {
        return __awaiter(this, void 0, void 0, function* () {
            const assetsToRemove = constants_1._.difference(this.siteConfig.ignore, oldIgnore);
            if (!constants_1._.isEqual(oldIgnore, this.siteConfig.ignore)) {
    ...
    handleStyleReload(oldStyle) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!constants_1._.isEqual(oldStyle.bootstrapTheme, this.siteConfig.style.bootstrapTheme)) {
    ...
    isFilepathAPage(filePath) {
        ...
        const srcesFromPages = constants_1._.flatMap(pages.filter(page => page.src), page => (Array.isArray(page.src) ? page.src : [page.src]));
        if (srcesFromPages.includes(relativeFilePath)) {
            return true;
        }
        const filePathsFromGlobs = constants_1._.flatMap(pages.filter(page => page.glob), page => this.getPageGlobPaths(page, pagesExclude));
    ...
    copyBootstrapTheme(isRebuild) {
        ...
        if ((!isRebuild && !bootstrapTheme)
            || (bootstrapTheme && !constants_1._.has(SUPPORTED_THEMES_PATHS, bootstrapTheme))) {
            return constants_1._.noop;
        }
    ...
    getDepOptions(ciTokenVar, defaultDeployConfig, publish) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ciTokenVar) {
                const ciToken = constants_1._.isBoolean(ciTokenVar) ? 'GITHUB_TOKEN' : ciTokenVar;
