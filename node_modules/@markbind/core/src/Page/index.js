...
class Page {
     ...
     */
    filterIconAssets(preVueSsrHtml, postVueSsrHtml) {
        const $preVueHtml = cheerio_1.default.load(preVueSsrHtml);
        const $postVueHtml = cheerio_1.default.load(postVueSsrHtml);
    ...
    processFrontmatter(frontmatter) {
        ...
        this.layout = this.layout || this.frontmatter.layout || Layout_1.LAYOUT_DEFAULT_NAME;
    }
    /**
    ...
    generate(externalManager) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield externalManager.generateDependencies(pageSources.getDynamicIncludeSrc(), this.includedFiles, this.pageUserScriptsAndStyles);
