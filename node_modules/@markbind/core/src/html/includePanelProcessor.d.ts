 ...
 */
export declare function processInclude(node: MbNode, context: Context, pageSources: PageSources, variableProcessor: VariableProcessor, renderMd: (text: string) => string, renderMdInline: (text: string) => string, config: Record<string, any>, getNextFootnodeNumber?: () => number): Context;
/**
